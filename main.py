# SpeedCallerBot v4 — Надёжная версия
import os
import re
import sqlite3
import logging
...
def send_current_number(chat_id, user_id):
    ...
    if not number_data:
        ...
        kb.row(InlineKeyboardButton("⏭️ SKIP", callback_data="skip"),
...
def callback_handler(call):
    ...
    if call.data == "load_menu":
        ...
        conn.commit()
        bot.answer_callback_query(call.id, f"📞 CALLING {get_current_number(user_id)[0][1]}")
